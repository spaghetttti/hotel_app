...
public class ApplicationConfig {
    ...
    CommandLineRunner commandLineRunner() {
        return args -> {
            ...
            listOfAgencies.add(new Agency("Agency 1", 10.0, "agency_1_hotels", PasswordHasher.hashPassword("password1")));
            listOfAgencies.add(new Agency("Agency 2", 5.0, "agency_2_hotels", PasswordHasher.hashPassword("password2")));
            agencyRepository.saveAll(listOfAgencies);

            ArrayList<Hotel> listOfHotels = new ArrayList<>();
            listOfHotels.add(new Hotel("Sample Hotel 1", "Country 1", "City 1", "Street 1", "123", 5, "hotel1@example.com", "123.456, 789.012",5, listOfAgencies.get(0)));
            listOfHotels.add(new Hotel("Sample Hotel 2", "Country 2", "City 2", "Street 2", "456", 4, "hotel2@example.com", "456.789, 012.345",3, listOfAgencies.get(0)));
            listOfHotels.add(new Hotel("Sample Hotel 3", "Country 3", "City 3", "Street 3", "789", 3, "hotel3@example.com", "789.012, 345.678",4,  listOfAgencies.get(0)));
            listOfHotels.add(new Hotel("Sample Hotel 4", "Country 4", "City 4", "Street 4", "012", 2, "hotel4@example.com", "012.345, 678.901",6,  listOfAgencies.get(1)));
            ...
            listOfRooms.add(new Room(hotel1, "Suite", 3, 250.0)); // Example room for demonstration
            listOfRooms.add(new Room(hotel1, "Standard", 1, 100.0));
            listOfRooms.add(new Room(hotel2, "Double", 1, 150.0)); // Example room for demonstration
            listOfRooms.add(new Room(hotel2, "Standard", 2, 120.0)); // Example room for demonstration
            listOfRooms.add(new Room(hotel3, "Double", 2, 175.0));
            listOfRooms.add(new Room(hotel3, "Standard", 1, 80.0 ));
            listOfRooms.add(new Room(hotel4, "Suite", 4, 300.0));
            listOfRooms.add(new Room(hotel4, "Standard", 1, 120.0));
